            ...
            ">
                <div class="slide" style="
                    ...
                    background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)),
                               url('https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=800') center/cover;
                    display: flex;
                ...
                ">
                    ...
                    <div style="font-size: 1rem; font-weight: 400; margin-top: 0.5rem; opacity: 0.9;">
                ...
                <div class="slide" style="
                    ...
                    height: 100%;
                    background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)),
                               url('https://images.unsplash.com/photo-1556075798-4825dfaaf498?w=800') center/cover;
                    display: flex;
                    flex-direction: column;
                    align-items: center;
                    justify-content: center;
                ...
                ">
                    ...
                    AI-Powered Insights
                    <div style="font-size: 1rem; font-weight: 400; margin-top: 0.5rem; opacity: 0.9;">
                        Smart contract analysis and review
                    </div>
                </div>
                <div class="slide" style="
                    width: 33.333%;
                    height: 100%;
                    background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)),
                               url('https://images.unsplash.com/photo-1589994965851-a8f479c573a9?w=800') center/cover;
                    display: flex;
                    flex-direction: column;
                    align-items: center;
                    justify-content: center;
